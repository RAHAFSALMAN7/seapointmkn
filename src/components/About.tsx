                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative animate-fade-in-left">
                        ...
                        <div className="relative">
                            ...
                            <img
                                ...
                                alt="Sea Point Development"
                                className="w-full h-[600px] object-cover rounded-2xl shadow-2xl relative"
                            />
                        </div>
                    </div>
                    ...
                    <div className="animate-fade-in-right">
                        <div className="mb-8">
                            ...
                            <div
                                className={`w-32 h-1 bg-gradient-to-r from-[#D9C18E] to-transparent mb-8 ${language === "ar" ? "" : "bg-gradient-to-l"
                                    }`}
                            />
                        </div>

                        <div
                            className={`space-y-6 text-lg text-gray-700 leading-loose ${language === "ar" ? "text-justify" : "text-left"
                                }`}
                        >
