export const content = {
  ar: {
    ...
    projectIntro: {
      ...
      description:
        'نقدم لكم سي بوينت… مشروع سكني يجمع بين التصميم العصري والراحة الفائقة. كل فلة في سي بوينت تأتي بتخطيط مدروس، ومساحات رحبة، وتفاصيل معمارية تلائم أسلوب الحياة المعاصر. تم تصميم المشروع بعناية فائقة ليوفر لك ولعائلتك بيئة سكنية راقية تحقق أعلى معايير الجودة والرفاهية.'
    },
    ...
    tour: {
      title: 'استكشف الفلة النموذجية بتجربة 360°',
      subtitle: 'جولة افتراضية تفاعلية تتيح لك استكشاف كل تفاصيل الفلة من منزلك',
      cta: 'انقر للبدء بالجولة الافتراضية',
      description:
...
smartHomeSection: {
  ...
  videos: [
    ...
    features: {
      ...
      items: [
        { title: 'تصميم عصري', description: 'تصاميم معمارية حديثة تجمع بين الأناقة والوظيفية لتناسب ذوقك الرفيع' },
        { title: 'مساحات واسعة', description: 'مساحات سخية ومرنة توفر راحة استثنائية لك ولعائلتك' },
        { title: 'تهوية وإضاءة مميزة', description: 'تصميم يراعي دخول الإضاءة الطبيعية والتهوية المثالية في كل الأوقات' },
        { title: 'تشطيب فاخر', description: 'خامات عالية الجودة وتشطيبات راقية تضمن لك الفخامة في كل ركن' },
        { title: 'تقنية المنزل الذكي', description: 'نظام ذكي متكامل للتحكم في الإضاءة والحرارة والأمن بلمسة واحدة' },
        { title: 'موقع استراتيجي', description: 'موقع متميز قريب من جميع الخدمات الأساسية والمرافق الحيوية' }
      ]
    },
    ...
    footer: {
      ...
      links: ['المشروع', 'المميزات', 'معرض الصور', 'من نحن'],
      contact: 'تواصل معنا',
      location: 'المملكة العربية السعودية',
      copyright: '© 2024 سي بوينت للتطوير العقاري. جميع الحقوق محفوظة',
  ...
  en: {
    ...
    projectIntro: {
      ...
      description:
        'We present Sea Point… a residential project that combines modern design with exceptional comfort. Every villa in Sea Point comes with a well-thought-out layout, spacious areas, and architectural details that suit contemporary lifestyles.'
    },
...
,
    ...
    features: {
      ...
      items: [
        { title: 'Modern Design', description: 'Contemporary architectural designs that combine elegance and functionality' },
        { title: 'Spacious Areas', description: 'Generous and flexible spaces providing exceptional comfort' },
        { title: 'Distinctive Ventilation & Lighting', description: 'Design that ensures natural lighting and optimal ventilation' },
        { title: 'Luxurious Finishes', description: 'High-quality materials and elegant finishes ensuring luxury' },
        { title: 'Smart Home Technology', description: 'Integrated smart system to control lighting, temperature, and security' },
        { title: 'Strategic Location', description: 'Prime location close to all essential services and facilities' }
      ]
    },
    ...
    footer: {
      ...
      copyright: '© 2024 Sea Point Real Estate Development. All rights reserved',
